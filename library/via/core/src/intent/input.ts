...
export type TypeOfParserTree<T extends ParserTree<unknown>> = T extends Parser<infer U>
  ? U
...
export type PartialTypeOfParserTree<P extends ParserTree<unknown>> = P extends Parser<infer U>
  ? U | undefined
...
export type InputStateTree<P extends ParserTree<unknown>> = P extends Parser<infer U>
  ? InputState<U>
  : P extends ParserTree<infer U>[]
    ? InputStateArray<U>
    : P extends { [key in keyof P]: ParserTree<P[key]> }
...
export type InputValueTree<P extends ParserTree<unknown>> = P extends Parser<infer U>
  ? InputValue<U>
  : P extends { [key in keyof P]: ParserTree<P[key]> }
